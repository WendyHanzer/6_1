...
void main(void)
   {
	   ...
	   dl[0].Base.DiffuseIntensity = 0.5;
	   dl[0].Base.SpecularIntensity = 10000.0;
	   ...
	   pl[0].Base.SpecularIntensity = 10000.0;
	   pl[0].Base.Position = vec3(20.0,light2x,2.0);
	   ...
	   vec4 ambient = vec4(dl[0].Base.Color, 1.0) * .7;
